  ...
  return (
    <section id="contact" className="relative overflow-hidden py-24 md:py-32">
      ...
      <div className="relative mx-auto max-w-5xl px-5 text-center md:px-8">
        <Reveal className="mb-6 flex items-center justify-center gap-4 font-mono text-[11px] tracking-[0.35em] text-muted uppercase">
          <span className="text-cyan">{c.index}</span>
          <span className="h-px w-10 bg-cyan/40" />
          {c.kicker}
        </Reveal>

        <h2 className="font-display text-[clamp(2.6rem,7.5vw,5.5rem)] leading-[1.02] font-bold tracking-tight">
        ...
        <Reveal delay={0.16} className="mt-10 flex flex-wrap justify-center gap-4">
          ...
          <Magnetic>
            ...
            >
              <Icon name="phone" className="h-5 w-5 text-cyan" /> WhatsApp
            </a>
          </Magnetic>
        </Reveal>
